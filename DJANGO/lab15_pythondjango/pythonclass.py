...
class Person:
    ...
    #return string 
    def __str__(self):
        return f"User {user1.name} is {user1.age} years-old"
...
#create an object of the class Number 
n1 = Number(12)
#print object of class Number
...
class Chair: 
    ...
    #method to calculat ethe total dimension 
    def total_dimension(self):
        return  self.height * self.length * self.width

    #method to calculate total shipping cost 
    def total_shipping(self):
        return self.shippingcostfee * self.total_dimension()
...
chair1 = Chair(3,4,5)
# print the object 
print(f'Result for the {chair1.chair_color} is ${chair1}')
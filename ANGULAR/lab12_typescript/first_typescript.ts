...
// numbers= ['fish', 'dog', 'cat']  -> will not work because once an implicit is already set once it can not change, if you want a changeable variable/array, use :any
// console.log(numbers)
...
let a : any 
a = 7;
console.log("b = 7", typeof(a))
a = "Peter Pan"
console.log("b = 'Peter Pan'", typeof(a))
a = true
console.log("b = 'true'", typeof(a))
...
let b : unknown 
b = 5;
console.log("a = 5", typeof(b))
b = "Martha"
console.log("a = 'Martha'", typeof(b))
b = false
console.log("a = 'false'", typeof(b))
...
let firstname = "Luisa"
// (optional) still works but in case it doesn't it helps to cast 'firstname' into a string (traditional way to do this)
...
function get_average(...n:number[]):number{
    ...
    average = total/count //or (n.length)
    return average
}
...
// access model data of the Car through 'usercar'
...
console.log('calling the method "save()" of the model "customer1"')
customer1.sale()
// calling the inherent method 'save()' through model 'customer1'
console.log('calling the method "save()" of the model "employee1"')
customer1.save()
